...
bcfac=numcxx.asdarray([fvm2d.Dirichlet,fvm2d.Dirichlet,fvm2d.Dirichlet,fvm2d.Dirichlet,fvm2d.Dirichlet])
...
def solve(h):
    ...
    fvm2d.assemble_heat_problem_with_source(grid,bcfac,bcval,source,kappa,S, Rhs);
...
plt.draw()
plt.savefig("test-fvm2d-convergence-h.pdf")
...
plt.draw()
plt.savefig("test-fvm2d-convergence-N.pdf")
